...
exports.dereference = function(doc, keys, callback){
    ...
    exports.open(function(err, db){
        if(err){
            ...
            ep.after('deref', Util.objectSize(keys), function(/*list*/){
...
exports.addHelper(exports, 'OAuthAccessTokens');
exports.addHelper(exports, 'OAuthRefreshTokens');
exports.addHelper(exports, 'OAuthClients');
exports.addHelper(exports, 'OAuthCodes');

exports.addHelper(exports, 'Users');
exports.addHelper(exports, 'Organizations');
exports.addHelper(exports, 'OrganizationUsers');